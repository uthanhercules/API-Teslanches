...
const { listarPedidos, listarPedidos2 } = require('./controladores/pedidos/listarPedidos');
...
rota.get('/pedidos/:idPedido', listarItensDoPedido);
...
rota.get('/pedidos', listarPedidos);
rota.get('/pedidos2', listarPedidos2);
